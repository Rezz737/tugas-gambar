        ...
        <form action="proses1.php" method="POST">
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <input class="form-check-input" type="radio" name="jenis_kelamin" <?php if ($kelamin == 'laki-laki') {
                                                                                                echo "checked";
                                                                                            } ?> value="laki-laki">
                    <label class="form-check-label" for="laki-laki">Laki-Laki</label><br>
                    <input class="form-check-input" type="radio" name="jenis_kelamin" <?php if ($kelamin == 'perempuan') {
                                                                                                echo "checked";
                                                                                            } ?> value="perempuan">
